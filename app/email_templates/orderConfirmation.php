...
// TODO(Trystan): Update placeholder info to real info.
                                            ...
                                            <tr>
                                              <th class="small-12 large-6 columns first">
                                                <table>
                                                  <tr>
                                                    <th>
                                                      <p> <strong>Delivery Address</strong><br> ' . $order['delivery_address']['line'] . '<br> ' . $order['delivery_address']['city'] . ', ' . $order['delivery_address']['state'] . $order['delivery_address']['zip_code'] . ' </p>
                                                    </th>
                                                  </tr>
                                                </table>
                                              </th>
                        ...
                        <tr>
                          <th class="small-12 large-3 columns first">
                            <table>
                              <tr>
                                <th>
                                  <p> Any issues?<br> Email us at me@trystanbrock.dev </p>
                                </th>
                              </tr>
                            </table>
                          </th>
                          <th class="small-12 large-3 columns last">
                            <table>
                              <tr>
                                <th>
                                  <p>  7528 Cedarwood St<dbr> Carter Lake, IA 51510 </p>
                                </th>
                              </tr>
                            </table>
                          </th>
